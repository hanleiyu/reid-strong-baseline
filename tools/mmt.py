...
def create_model(cfg, num_classes):
    ...
    model_1.load_state_dict(cfg.MODEL.init_1)
    model_2.load_state_dict(cfg.MODEL.init_2)
    model_1_ema.load_state_dict(cfg.MODEL.init_1)
    model_2_ema.load_state_dict(cfg.MODEL.init_2)
