...
dir = '/home/yhl/project/SPIN/'
CUBE_PARTS_FILE = dir + 'data/cube_parts.npy'
JOINT_REGRESSOR_TRAIN_EXTRA = dir + 'data/J_regressor_extra.npy'
JOINT_REGRESSOR_H36M = dir + 'data/J_regressor_h36m.npy'
VERTEX_TEXTURE_FILE = dir + 'data/vertex_texture.npy'
STATIC_FITS_DIR = dir + 'data/static_fits'
SMPL_MEAN_PARAMS = dir + 'data/smpl_mean_params.npz'
SMPL_MODEL_DIR = dir + 'data/smpl'
